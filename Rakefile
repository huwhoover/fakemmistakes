...
task :post do
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "image:"
    post.puts "  feature: sample-image-5.jpg"
    post.puts "  credit:"
    post.puts "  creditlink:"
    post.puts "---"
    post.puts '<section id="table-of-contents" class="toc">'
    post.puts "    <header>"
    post.puts "      <h3>Overview</h3>"
    post.puts "    </header>"
    post.puts '  <div id="drawer" markdown="1">'
    post.puts "  *  Auto generated table of contents"
    post.puts "  {:toc}"
    post.puts "  </div>"
    post.puts "  </section><!-- /#table-of-contents -->"
  end
end # task :post
